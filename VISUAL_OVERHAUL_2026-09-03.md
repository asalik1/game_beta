...
- Mobile: `sync_mobile.py --apply --gate` → **GATE OK** four times (2026-09-05 05:17: 341 files; 12:24: 287; 13:17: 29; **15:19 after the 21 death clips: 21 files**; mobile compile 121 scripts + quick suite passed each time). Final desktop pass after the deaths (15:20): confirming `--import` exit 0, PREFLIGHT OK, AUTOTEST QUICK PASS. Note for the next sync after a big PNG batch: the gate's first `--import` can exceed its 600s watchdog; run the mobile import by hand once, then re-run the gate.
