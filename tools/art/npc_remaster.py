...
Generate ONE image: the single figure, centered, filling most of the canvas, on a FLAT SOLID
PURE-GREEN (#00FF00) background -- fill every pixel that is not the figure with that green,
and use NO other green anywhere in the figure. (Asking for transparency is unreliable: three
of seven facings came back on WHITE, 2026-09-06.) Painterly, soft-shaded, NO black outlines, muted palette, top-down
