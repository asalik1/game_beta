...
| `tools/art/run_codex_batch.ps1` | fire a batch of headless Codex image_gen jobs in parallel (one per staging dir, refs auto-globbed) and wait for all — the throughput engine for a multi-boss run. `-Stages "dir1,dir2,…"`. |
