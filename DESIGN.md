...
**Open items:** (1) **Ch2 is a reward hole** — legacy 10-room chain, zero social/dead-end/resonance rooms, worst g/min in the game (36.5 vs ch3's 71, audit 2026-07-24 — now UNDER ch1's 38.8 too): fix by graph-retrofit, not by inflating its numbers. (2) The 15–25% first-clear share and the 65% gem-quality cap are first guesses — confirm in the difficulty-tuning playtest. (3) Replay time assumption (32 min vs 55 first) is the audit's weakest estimate — check against real replays.
