...
**Sink sizing (frontier farm minutes per purchase, from the audit):** potion ≈ 30s · smith +3 ≈ 1–2 min · one reforge sub-roll ≈ 2–3 min (RNG craft, rolled many times — cheap singles by design) · gold-tier gamble ≈ 3–4 min · S-socket 1500 ≈ 8–10 min. A meaningful BUILD STEP (gem tier via synthesis, a reforge pass, an A-piece hunt) ≈ 2–4 replays — the "farm a chapter a few more times" sweet spot, by construction.
