	...
	"archer": {
		"a1": {
			"storm": {"desc": "The arrow forks with lightning, leaping to a second enemy — on lone prey the charge arcs BACK for a second strike.",
				"fx": {"ric": 1, "splash": 0.20, "ric_back": 0.50}},
		...
		"a2": {
			...
			"venom": {"desc": "THREE heavy toxin arrows in a tight fan — each drips a brutal, STACKING DoT.",
				"fx": {"knives": 3, "spread": 0.10, "dmg_mult": 1.7, "dot": 0.50, "slow": 0.25, "toxin": 1}},
	...
	"warlock": {
		...
		"a2": {
			"curse": {"desc": "Deeper rot: the curse withers harder, and death-detonations hit 50% harder.",
				"fx": {"dot": 0.55, "hex_boom": 1.5}},
			"pact": {"desc": "Leeching curse: every cursed enemy's death mends 8% of your max HP.",
				"fx": {"hex_heal": 0.08}},
			"void": {"desc": "The curse bends space: cursed enemies are wrenched off-balance and SLOWED to a crawl, and the curse itself CRUSHES the displaced.",
				"fx": {"slow": 0.50, "slow_dur": 3.0, "crush": 1, "shove": 260.0}},
		},
		"a3": {
