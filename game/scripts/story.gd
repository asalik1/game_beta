...
# The speaking cast, one canon bio each — keyed by SPRITE so the codex Folk
# section can reveal the person behind the portrait instead of a generic
# blurb. Voice matches the relic/terrain lore (pc_curios.gd, terrains.gd):
# present tense, a concrete image plus a turn that hooks real canon, no
# second person, no em dashes. Kept true to what each NPC says in their convo.
const NPC_LORE := {
	"elder": "She finds the newly-woken before the factions do, and asks them for nothing but eyes and honesty while everyone else asks for everything. Forty years of sending people into impossible rooms has left her fluent in the arithmetic of who to spend, and quietly terrified each time the sum comes out a person she has grown to like.",
	"piet": "The palisade watch, who has learned to tell the blight-mad wolves from the honest kind by his second week on the line. He stands the night easier with a steady shard-bearer beside him, and still dreams about the fence over the one who came through wearing that other look.",
	"sera": "She kept a mill on the Greyrun until the water came up black one morning and the blight took the rest. She holds to Maren's promise that the land can be cleaned because someone has to, and would trade a year of her life to know the mill's blue door is still standing.",
	"callis": "An Ember Accord warden who wants every shard gathered and the hollow throne broken for good, one honest day the bearer's own included. She asks the strong to become less so the world can be more, and has buried enough friends who listened to the other voice to keep her hand near her hilt while she makes the case.",
	"vessa": "An envoy of the Cinderborn who does not miss the tyrant so much as the roads, the granaries, and the law he kept. She recruits with a ledger's smile and pays in coin rather than sermons, certain a crown is only a tool the bleeding world has mislaid.",
	"caged_beastkin": "A wiry Wildfang scout, Fangmaw's blood three generations on, brought into the camp behind bars the sentries keep arguing over. It watches with too-clever eyes and says little, except that a cage is a cage whoever holds the key, and the Tribes remember exactly who opens doors.",
	"choir_pilgrim": "A grey-wrapped pilgrim who sways at the gate humming a hymn with no words anyone knows, and preaches that the rot is honest because it only takes what was already leaving. The sentries will not touch her, and the Hollow Choir she keeps does not recruit so much as wait.",
	"aldric": "The knight who killed Vargoth thirty years gone, and spent his own ember in the blow, so the arm no longer lifts past the shoulder. He calls it the cheapest thing he ever bought, and keeps one secret next to the bad arm: the Crown was never defeated that day, it dismissed itself, and every shard since went looking for a bearer to choose.",
	"scholar_ivo": "A chronicler camped among the singing crystals, counting the Waking and insisting he is unaffiliated whatever the envoys claim. He warns that the deep crystals repeat what they hear, and that the thing stirring in the old Bastion is neither blight nor beast but maintenance, resumed after six hundred years and finding the whole region out of specification.",
	"cantor_ilse": "A cantor who sang the Hollow Choir's liturgy for thirty years before she finally heard the words in it, then walked out the day they voted to keep a dying saint alive as furniture. What she asks of a bearer now is the mercy her old faith calls murder: let the man who has begged to die for sixty years finally stop kneeling.",
	"warden_corin": "An Accord warden posted over the grave-vale because every unburied corpse out there is a straw drawing blight up from Mórwyn's table. He does not see a graveyard when he looks downhill; he sees a wick, and the Choir's honest grief patiently feeding it.",
	"factor_imre": "A Cinderborn factor unashamed to be making money off a graveyard, since the Vale sits astride the best freight road south and sixty years of eternal funeral has kept it closed. He argues that order is not a dirty word and empires run on unglamorous arithmetic, though grief with sixty years of interest is the one debt he will not broker.",
	"old_fenna": "Her son walks the Misted Fields, fourth grave from the alder in a grey coat she sewed for a living boy. The Choir calls that honored; she calls it unfinished, and wants him felled facing home and put in the ground where coats and sons belong.",
	"overseer_brann": "The overseer of what is left of the southern foundry line, a company man whose ledger stopped balancing four crews ago. He signed the requisition that let his chaplain preach closer to the heat, and now blades will not break, something haunts the deep vents, and every name he adds to the blank memorial is one more he answers for.",
	"envoy_cassia": "A Cinderborn envoy who says the quiet part first: yes, the Compact drilled the seal, yes, something under the rock woke, and no, she is not sorry, because the ore off this line will arm every wall when the Waking comes for the rest. She insists Vargoth's ghost never lived in the crown but in the furnaces, working three shifts and worth the screaming.",
	"warden_edda": "An Accord warden blunter than any envoy, who names the mountain plainly: a seal, one of the four, with a two-year Compact drilling operation bored into its lid. She reads the danger as attention rather than force, every sermon and obeyed whisper a hand pressing on the door, and asks only that a bearer take the hands off.",
	"smith_petra": "The only smith of crew five still breathing, saved by a broken wrist that kept her topside the day the vents took the other nine. She carries their names like tools waiting to be used, and has sharpened a good chisel to cut all nine into the plaque herself, since in two years the Compact never once asked what they were.",
	"tracker_yri": "A tracker of the Wildfang winter clans who warns, before anything else, that nobody in her valley is evil, and that is exactly what makes it hard. Her cousins' children have marrow in their bones because of the cult's grain, and she needs a bearer to understand that before the ridge and not after, because the clans will hear how the killing gets told.",
	"warden_sighne": "An Accord warden who will not soften the arithmetic she carries. The keystone under the frozen shore is locked by Serane, an Ember Guard who volunteered six hundred years ago to freeze at the seal as its living bolt, still loyal and worn thin by the Waking. Sighne has run the cruel sum a dozen ways and asks a bearer for the clean death anyway, flame forgive them both.",
	"suli": "She drives wagons for the Long Sleep, and put her own dying daughter Wren on one of them, choosing a dream over a grave. Nine years and not one sleeper has died, which is the whole of her faith and her defense, though some nights on the road she hears the ice underneath and thinks it sounds less like a nursery than a pantry.",
	"ansa_shore": "Her husband and both boys sleep in the valley ice, walked off smiling behind the cult's singers one market day she was away and never consented to. Her youngest, Toma, is afraid of the dark, and she cannot believe he went toward that cold glad. She holds hardest to anyone who says when the sleepers wake, not if.",
	"deacon_vela": "A Choir deacon of the drowned pilgrimage, who preached for sixty years that rot is the land's honesty and watched the creed hold through plague and grave-vale until it met the Deep's waterline. Out here, she says, deacon mostly means the one who keeps the count when people do not come back, and half the flock she prayed beside for twenty years is still out there, knee-down in the moss.",
	"herbalist_kesh": "Second of the Wildfang cure-camp, who sent the runner that brought a bearer to the Deep and means the weight of it to start with her. Her teacher Kaethra was too honest to test the Root's green on anyone but herself, and it worked: the beast-blood is gone, and something patient has moved into the empty room. Kesh wants the answer carried back to both camps, whatever it turns out to cost.",
	"warden_palla": "An Accord warden sent to the Deep with a single sentence she has been chewing since: the Pale Root is the seal to fear, not the Judge with his theater or the Queen with her sleepers. Fire and ice announce themselves, she says, but growth just quietly disagrees with every boundary it meets, and this seal does not break so much as grow through, hair-thin, wherever a living thing invites it in.",
	"fisher_dov": "Thirty years he fished a bog that only ever took, a net a season and a cousin a decade, and he made his peace with that. Then last spring it began giving back, and his dog four winters dead came scratching at the door one morning looking exactly right, which is how he knew to move up to the gate. He still leaves the door unlatched at night, and cannot quite say why.",
	"commander_ashe": "The Warden-Commander of the whole Ember Accord, come to the summit because that is what the end of an act of the world looks like, everyone important standing in the same rain pretending they planned it. She makes the age's last Accord pitch unvarnished: gather the shards, break the throne, crown no one, and let everyone who touched that power be voluntarily smaller for it. A terrible offer, and the only one where the next generation are nobody's subjects.",
	"consul_verane": "A Consul of the Cinderborn, the Compact's true leadership come to stop auditioning a bearer and simply make the offer. When the sky cracks, he argues, terrified people will not want thrones broken but walls held, bread on schedule, and someone visibly in charge, the three things the empire delivered for two hundred years. His only open question is whether the head worthy of the next crown belongs to someone the Compact has already watched cross four provinces.",
	"apprentice_sorrel": "The last apprentice of the Speaker's order, who learned the six-hundred-year recitation the traditional way, one line a season, and got four lines deep before the storm claimed his master's attention. When the Speaker dies he is the nearest thing left to a keeper of the binding, a fact everyone at the summit carefully avoids saying to him. He has written his four lines down forty times and hidden the copies, paper in a boot, wax under a hearthstone.",
	"merchant": "The traveling trader who sets a stall wherever the road pauses long enough for anyone to spend coin, from a stilt camp in the marsh to a smugglers' postern under a fallen keep. The stock changes with the danger of the country around it, and the gossip is always free, whether or not a word of it is true.",
}
...
const CONTENT_MODULES: Array = [
	...
	preload("res://scripts/content/chapter_closers.gd"), # per-class illustrated chapter-end closers
