...
const PASSIVES := {
	...
	"archer_armor_Da": "Your first hit on an unwounded enemy strikes 15% harder",
	"archer_armor_Ds": "Your first hit on an unwounded enemy strikes 25% harder, and the first strike of the hunt throws the prey back",
	...
	"assassin_armor_Da": "Your first hit on an unwounded enemy strikes 15% harder",
	"assassin_armor_Ds": "Your first hit on an unwounded enemy strikes 25% harder, and the blade never seen feeds the surge",
	...
	"assassin_charm_Aa": "Your first hit on an unwounded enemy strikes 15% harder",
	"assassin_charm_As": "Your first hit on an unwounded enemy strikes 25% harder, and writing the final name feeds the surge",
