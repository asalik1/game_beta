...
const CONVOS := {
	"ch2_aldric": {"start": "g1", "nodes": {
		"g1": {"who": "Ser Aldric",
			"text": "Don't salute. The arm doesn't come up past the shoulder anymore, and returning it just embarrasses us both. Sit, shard-bearer. The fire's the only thing here that still burns properly.",
			"variants": [
		...
		"p3c": {"who": "Ser Aldric",
			"text": "It wasn't defeated, bearer. It dismissed itself. The scattering wasn't an accident of my blow. The shards went looking. Which means every one of you was picked, by something with six hundred years of patience and a grudge against chains. I never told Maren because she'd have hunted every bearer down just to be safe. And because... maybe being chosen isn't the same as being owned. You lot get to decide that part. That's the whole of my hope, and I keep it right here next to the bad arm.",
			"variants": [
