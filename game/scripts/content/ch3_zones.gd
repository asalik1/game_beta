	...
	"ch3": [
		...
		},
		{
			...
			"enemies": [
				...
				["gravewalker", 1700, 450, 2], ["gravewalker", 1820, 560, 2], ["cultist", 1760, 340, 2, 16, 11],
				["plague_chanter", 1000, 950, 3, 16, 13], ["plague_chanter", 1130, 880, 3, 16, 13],
			],
			"boss": "",
		},
		{
		...
		},
		{
			...
			"enemies": [
				...
				["casket_creeper", 1700, 420, 2, 20], ["plague_chanter", 1820, 530, 2, 20, 17],
				["casket_creeper", 1760, 320, 2, 20], ["plague_chanter", 1880, 420, 2, 20, 17],
				["casket_creeper", 1000, 620, 3, 20], ["casket_creeper", 1130, 550, 3, 20],
				["null_acolyte", 950, 760, 3, 20, 18], ["barrow_wight", 1080, 830, 3, 20],
			],
			"boss": "",
		},
		{
		...
		},
		{
			...
			"enemies": [
				...
				["cultist", 1350, 850, 1, 19, 17], ["barrow_wight", 1470, 780, 1, 19],
...
const ENEMIES := {
	"gravewalker": {"name": "Unburied Walker", "sprite": "zombie", "hp": 185.0, "dmg": 29.0, "speed": 118.0, "xp": 11, "gold": 12, "ranged": false, "scale": 3.1,
	...
	"barrow_wight": {"name": "Barrow Wight", "sprite": "skeleton_rogue", "hp": 205.0, "dmg": 32.0, "speed": 140.0, "xp": 13, "gold": 14, "ranged": false, "scale": 3.2,
	...
	"casket_creeper": {"name": "Casket Creeper", "sprite": "casket_creeper", "hp": 180.0, "dmg": 37.0, "speed": 210.0, "xp": 15, "gold": 16, "ranged": false, "scale": 3.1,
		"physres": 5.0, "magres": 12.0, "eva": 0.14, "critres": 0.0, "dmg_type": "phys",
		"level": 19, "hp_g": 0.10, "dmg_g": 0.09, "traits": ["bloat", "pounce"],
