...
static func selftest(_game: Node2D) -> String:
	...
	var coords := {}
	var known_actions := ["codex", "daily", "drill", "forge", "guild", "journal", "lapidary", "mail", "map", "portal_crucible", "portal_depths", "portal_story", "potions", "professions", "records", "synthesis", "vault", "wardrobe"]
	for z in ch["zones"]:
		if z.get("type", "") != "safe":
