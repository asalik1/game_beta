...
const BEATS := {
	...
	"post_cinderhide@flag:ch4_petra_told": [
		...
		["Narrator", "On the gallery wall above the vent, the fifth plaque hangs blank on its bolts, waiting, the way it's waited two years. Not anymore. At the gate a smith keeps a sharpened chisel and nine names, and you promised her this was the day."],
	...
	"pre_stormmouth@flag:chose_carried_lines": [
		["Cyrraeth", "...and the word wasn't 'silence', bearer, that's the mistranslation, six centuries of it. The word was 'wait'. We were never keeping it in. We were keeping it wai... Stop. Stand very still. The storm hears it too: there are lines on you. Four of them, warm from a young voice, carried up my stair like a lamp."],
		["Cyrraeth", "Sorrel. Four years I fed him one line a season and called it tradition, and he's already done the one thing six hundred years of keepers were for: he passed them on. So hear me, relief-bearer. Kill the Mouth, mourn the Speaker; the sentence still has heirs. Come with me. One of us ends the recitation tonight, and for the first time since I stopped speaking... I'm not afraid of which."],
	],
}
...
const CONVOS := {
	...
	"ch3_refugee": {"start": "r1", "nodes": {
		"r1": {"who": "Old Fenna",
			...
			"variants": [
				{"flag": "ch3_fenna_told", "text": "The fourth plot from the alder stays closed now. \"Facing home,\" she says, once, like a woman checking a knot that held. There's thread on her sleeve. She's taken up sewing again. Not coats yet. But sewing.", "next": "r_bread"},
				{"flag": "ch3_fenna_son_rested", "text": "She's on her feet before you clear the gate, reading your face the way she once read weather for the mill. \"The fields. You've been in the fields. Fourth from the alder. Say it, bearer. Whichever way it is, say it.\"", "next": "r_tell"},
		...
		"r_home": {"who": "Old Fenna", "text": "Facing home. She doesn't weep; she's sixty years past the easy kind. She just breathes out, all the way down, maybe for the first time since the mill. \"Then he's done walking, and I'm done waiting, and the coat's where coats and sons go. You kept a promise the Choir spent sixty years singing over, bearer. Flame keep your roads short and your word this heavy always.\"", "next": ""},
		"r_stood": {"who": "Old Fenna", "text": "Where he stood. The words land and she takes them standing, the way she's taken everything else. \"I asked you for one direction, bearer. One. ...No. You put him down, and that's more than sixty years of hymns managed. But you'll forgive me if I don't thank you in the words I'd saved.\" She turns back to her fire, pointedly, deliberately facing home, for both of them.", "next": ""},
		# ---- Bread for the Kneeling (side quest): the offer (Q3, verbatim).
		"r_bread": {"who": "Old Fenna",
			"text": "There's a field of them below the cathedral, you know. Kneeling. The Choir sings over their heads and calls it feeding them. I've buried nothing in sixty years but I've baked every day of it, so take them a loaf, if your road goes up. Grief is grief. Even theirs.",
	...
	"ch3_lore_alder": {"start": "a1", "nodes": {
		"a1": {"who": "Narrator",
			...
			"next": ""},
		"a_home": {"who": "Narrator", "text": "It takes patience, and footwork, and one ugly moment when the grey coat's arms find your shoulders like a man being helped down from a cart. And then it's done, and he's down, and his face is west. Toward the mill road. You fill the grave yourself, with the Sexton's own abandoned spade, because a promise kept halfway is a promise broken politely. The mist stands off the whole time, respectful as a hired mourner. Somebody should tell his mother. Somebody promised to.", "next": ""},
	...
	"ch3_wander_mute": {"start": "m1", "nodes": {
		"m1": {"who": "The Mute Mourner",
			...
			"variants": [
				{"flag": "vess_dead", "text": "She's there, hands folded, but the folded hands are different now: loose, done. The Silent Aisle has gone quiet, and word of whose hand ended the liturgy reached her before you did. When she sees you she touches two fingers to her lips, holds them out, and bows her head. Nineteen years of vigil, discharged. It's the loudest thank-you you've ever been paid.", "next": ""},
				# Walked-past state (before ch3_mute_met — the two never mix):
				# she asked once, with a nod, and was answered. Final.
				{"flag": "ch3_mute_passed", "text": "She's there, hands folded, eyes on the east road. She doesn't look up as you pass. Nineteen years have taught her which footsteps to spend hope on, and yours, she's decided, aren't among them.", "next": ""},
				{"flag": "ch3_mute_met", "text": "She's there again, hands folded, eyes on the east road. The singing hasn't stopped yet. The contract holds. She checked your sword hand once, and went back to waiting.", "next": ""},
			],
			"choices": [
	...
	"ch4_survivor": {"start": "s1", "nodes": {
		"s1": {"who": "Smith Petra (Crew Five)",
			"text": "Crew five, that's me. The plaque downstairs is blank because I keep not dying and the engraver keeps waiting. Everyone else went in the vents. I was topside with a broken wrist, the clumsiest day of my life, and the only reason I've got a rest of my life.",
			"variants": [
			...
			"choices": [
				...
				{"text": "Hold out a worn pouch. \"From Nix. A refund for the verdict charms crew five bought. None of them worked, and she checked.\"",
				...
				{"text": "Hold out the pouch. \"Crew five had credit at the charm stall. It's yours now, and that's all the arithmetic there is.\"",
					"req_flag": "ch4_refund_taken", "req_not_flag": "ch4_refund_given",
	...
	"ch5_wander_skald": {"start": "k1", "nodes": {
		"k1": {"who": "Skald Ottar",
			...
			"variants": [
				...
				{"flag": "ch5_verse_given", "text": "It reached her? Then you're standing there owing me, southerner. The fee, like we agreed: the look on the first face that heard it. Out with it. I don't discount.", "next": "k_fee"},
