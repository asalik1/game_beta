...
const ENEMIES := {
	...
	"stormwarden": {
		...
		"hp": 12400.0, "dmg": 30.0, "speed": 170.0, "xp": 90, "gold": 66,
		...
		"lore": "He used to keep the warbands' beasts calm through the thunder. Now the thunder keeps him.",
		"mechanics": [
			{"name": "Lightning Lash",
			 "tell": "He winds up and whips a line of lightning strikes straight out through you, and each one lands a beat after the last.",
			 "counter": "Step sideways off the line. The strikes walk outward in order, so clearing the lane once gets you out of all of them."},
			{"name": "Whistle the Pack",
			 "tell": "At 66% and again at 33% he whistles and two wolves lope in beside him.",
			 "counter": "The wolves drop nothing, so don't stop to farm them. Peel them off or just keep kiting the warden. They thin out as the fight moves."},
			{"name": "Whip Snap",
			 "tell": "At mid range he flicks a single quick telegraph onto your feet to keep you honest.",
			 "counter": "It's a short cast. Sidestep it and either close in or back off. Don't sit parked at whip distance."},
			{"name": "The Storm Breaks (30%)",
			 ...
			 "counter": "He's faster now, and the sky is a second threat. Keep moving so the random bolts land where you were, not where you are."},
		],
	},
	...
	"choirmother": {
		...
		"hp": 18100.0, "dmg": 36.0, "speed": 120.0, "xp": 144, "gold": 114,
		...
		"mechanics": [
			{"name": "Requiem",
			 ...
			 "counter": "The rings spread away from her, so move inward toward the Mother between waves, or thread the gaps as each ring passes."},
			{"name": "Hymn of Hunger",
			 "tell": "She marks the ground under you, and when it strikes the choir feeds her and she heals back a slice of her health.",
			 "counter": "Leave the marked circle before it lands. Getting clipped feeds her, so deny the strike and you deny the heal."},
			{"name": "The Choir Answers (60%)",
			 "tell": "At 60% she calls and two cultists rise from the congregation to flank you.",
			 "counter": "The adds pay nothing, so don't chase loot. Keep the Mother as your focus, and clear the cultists only if they're boxing you in."},
			{"name": "The Choir Crescendos (25%)",
			 ...
			 "counter": "Everything comes faster now, so tighten your strafing and give the denser fans more room. Burn her down before the liturgy overwhelms you."},
		],
	},
	...
	"nullwarden": {
		...
		"hp": 33800.0, "dmg": 55.0, "speed": 100.0, "xp": 225, "gold": 180,
		...
		"mechanics": [
			{"name": "Piston Protocol",
			 "tell": "It stamps a four-column grid of slams across the ground under you, and the columns fire left to right in order.",
			 "counter": "The columns come in order, not all at once, so move along the sweep or against it and stay in a column that hasn't stamped yet."},
			{"name": "Beam Spoke",
			 "tell": "It rakes one long line of strikes straight down your lane, from itself out toward you.",
			 "counter": "Sidestep out of the lane. The whole beam is one straight line, so one step to the side clears all of it."},
			{"name": "Armor Shed (50%)",
			 "tell": "At 50% it sheds its plating, glows gold, warns ARMOR SHED, THE CORE IS EXPOSED, and moves faster.",
			 "counter": "Its physical armor drops hard, so this is your damage window. Commit your burst. It's quicker now too, so respect its melee and the faster beams."},
			{"name": "Overdrive (25%)",
			 "tell": "At 25% it flares red and engages OVERDRIVE, and every attack cycles noticeably faster.",
