...
const ENEMIES := {
	...
	"sun_bleached": {"name": "Sun-Bleached Husk", "sprite": "zombie", "hp": 165.0, "dmg": 22.0, "speed": 110.0, "xp": 48, "gold": 17, "ranged": false, "scale": 3.5,
		"physres": 18.0, "magres": 12.0, "eva": 0.0, "critres": 0.0, "dmg_type": "phys",
		"level": 10, "hp_g": 0.10, "dmg_g": 0.09},
	"frost_husk": {"name": "Frost-Bound Soldier", "sprite": "skeleton", "hp": 185.0, "dmg": 24.0, "speed": 125.0, "xp": 55, "gold": 20, "ranged": false, "scale": 3.4,
	...
	"null_acolyte": {"name": "Null Acolyte", "sprite": "cultist", "hp": 160.0, "dmg": 27.0, "speed": 110.0, "xp": 70, "gold": 26, "ranged": true, "scale": 3.3,
		"physres": 10.0, "magres": 28.0, "eva": 0.0, "critres": 3.0, "dmg_type": "magic",
		"level": 13, "hp_g": 0.11, "dmg_g": 0.10},
	"void_husk": {"name": "Voidbound Husk", "sprite": "skeleton", "hp": 260.0, "dmg": 30.0, "speed": 115.0, "xp": 85, "gold": 30, "ranged": false, "scale": 3.6,
