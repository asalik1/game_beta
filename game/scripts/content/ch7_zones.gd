...
const ENEMIES := {
	...
	"vow_sentinel": {"name": "Vow Sentinel", "sprite": "skeleton", "hp": 1250.0, "dmg": 92.0, "speed": 130.0, "xp": 15, "gold": 34, "ranged": false, "scale": 3.4,
	...
	"static_caller": {"name": "Static Caller", "sprite": "cultist", "hp": 1000.0, "dmg": 96.0, "speed": 100.0, "xp": 15, "gold": 34, "ranged": true, "scale": 3.2,
	...
	"void_shade": {"name": "Void Shade", "sprite": "assassin", "hp": 1050.0, "dmg": 100.0, "speed": 185.0, "xp": 16, "gold": 36, "ranged": false, "scale": 3.2,
