...
const ENEMIES := {
	...
	"whitepelt": {
		...
		"hp": 68500.0, "dmg": 135.0, "speed": 155.0, "xp": 520, "gold": 400,
		...
		"mechanics": [
			{"name": "Ice Charge",
			 "tell": "He winds up and barrels at you on a short leash, and the arena is ringed with frost patches he can't stop on.",
			...
			{"name": "Frost Stomp",
			 ...
			 "counter": "It's his answer to you never closing in: a slow, readable tell. Just step off your spot before it lands, and don't get greedy standing still."},
			{"name": "Pack Calls (66% / 33%)",
			 "tell": "He roars and two wolves peel in from the flanks.",
			 "counter": "The wolves drop zero loot, so don't chase them. Keep moving so they can't stack with him, and stay on the boss."},
			{"name": "Pelt Drums",
	...
	"icebound": {
		...
		"hp": 86500.0, "dmg": 140.0, "speed": 90.0, "xp": 560, "gold": 430,
		...
		"mechanics": [
			{"name": "Flash Freeze",
			 ...
			 "counter": "Sprint into a vent before the freeze lands. Get caught outside and you're frozen solid and vulnerable, a free hit for her. The vents move each cast, so read them fresh every time."},
			{"name": "Shatter Lance",
			 ...
			 "counter": "The line lands after the root breaks, so the instant you can move, dash off where you were standing rather than back through it."},
			{"name": "The Keystone Cracks (40%)",
			 "tell": "At 40% she flares blue-white and a ring of fresh ice spreads inward from the walls.",
			 "counter": "Her Flash Freeze quickens and drops to only two vents, so there's less thawed floor and faster exams. Keep your escape routes shorter and don't over-commit to damage."},
			{"name": "Icicle Rain",
	...
	"sleepkeeper": {
		...
		"hp": 131200.0, "dmg": 150.0, "speed": 85.0, "xp": 640, "gold": 560,
		...
		"mechanics": [
			{"name": "Lullaby Aura",
			 ...
			 "counter": "This flips every safe-spot fight: here, stillness is the danger. Keep moving to bleed Drowse off. Let it hit five and you fall Asleep, frozen and open. Never hand her a heal by standing still to cast."},
			{"name": "The Dreamers",
			...
			{"name": "Frost Hymnal",
			 ...
			 "counter": "Sidestep the circles early, then route around the slow patches they leave. That muck is what feeds the aura, pinning you in place."},
...
static func selftest(game: Node2D) -> String:
	for kind in ["whitepelt", "icebound", "sleepkeeper"]:
		...
		if b._boss_projectile_key() != "fx_boss_frost_lance":
