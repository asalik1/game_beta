...
const CONVOS := {
	...
	"ch2_shrine_sporefall": {"start": "s1", "nodes": {
		"s1": {"who": "Narrator",
			"text": "A spore-tree stands alone in the clearing, three times the height of the shamblers that grew from it. It breathes, a slow swell and settle that takes hours, and you've caught it mid-inhale. The air here is thick and faintly sweet. Somewhere in the Sporewood a bearer before you carved a mark into the bark, and then, by the look of the second mark, came back.",
			...
			"choices": [
				{"text": "Stand in the exhale and breathe it in. The Sporewood has been trying to tell somebody something for years.",
					"resonance": 8.0, "flags": {"sporefall_answered": true, "sporefall_listened": true}, "next": "s_breathe"},
				{"text": "Cut it open. Whatever the blight has been storing in there, it's been storing since before you were hungry.",
		...
		"s_breathe": {"who": "Narrator", "text": "You breathe, and for a moment you're very tall and very slow and rooted in one place for eleven years, and the thing you feel isn't malice. It's patience. The blight isn't angry at Vaelscar; it just has more time than Vaelscar does. You come back to yourself coughing, on your knees, and better informed than any Accord survey.", "next": ""},
		"s_cut": {"who": "Narrator", "text": "The trunk parts around a hollow the size of a cart, and the hollow is full of what the Sporewood has been quietly digesting: buckles, coin, a signet, the small hard leavings of everyone who walked in and didn't walk out. You take the coin. Behind you the tree finishes its exhale and doesn't start another, and you tell yourself trees don't do that.", "next": ""},
		"s_leave": {"who": "Narrator", "text": "You step back out of the clearing. The swell and settle goes on behind you at its own enormous pace, something that'll still be doing this when the Waking is just a chapter in somebody's ledger. You find the thought steadying, which surprises you.", "next": ""},
	}},
	"ch2_shrine_font": {"start": "f1", "nodes": {
		"f1": {"who": "Narrator",
			"text": "Everything in the Sanctified Ruins is broken except the font. The roof came down, the pillars went over, the Null Acolytes have been through twice, and the basin still stands, and the water in it is still clean. Not blessed-clean. Just clean, in a chapter of the world where nothing is. There's a tin cup on the rim, worn bright by hands.",
			...
			"choices": [
				...
				{"text": "Leave it untouched. You're carrying enough, and the basin isn't for you.",
		...
		"f_take": {"who": "Narrator", "text": "Four skins, a cup, and the basin drawn down to its stained ring. It'll refill; it always has. But the cup was the part that made it a font instead of a puddle, and now it's in your pack, and the next one through will find water and no way to reach it that doesn't involve kneeling in it.", "next": ""},
		"f_leave": {"who": "Narrator", "text": "You walk past the basin with your skins as empty as they were. It isn't virtue exactly. You just couldn't think of a way to take from it that felt like anything but taking. The cup sits on the rim, waiting for somebody less careful.", "next": ""},
	}},
	...
	"ch2_lore_ferry": {"start": "l1", "nodes": {
		"l1": {"who": "Narrator", "text": "A landing stage on the black water, and the ferryman still tied to his own post, rope around the waist, the way a man secures himself for a long night's work he means to survive. He took people out of the Greyrun for eleven days after the blight came up. The tally is cut into the post beside him, five and five and five, and the last group is a group of one, and the notch for it is deeper than the others, like it was cut slowly, by somebody with the evening free.", "next": ""},
	}},
	...
	"ch2_wander_snares": {"start": "s1", "nodes": {
		"s1": {"who": "Snarehand Ott",
			"text": "Twenty-two snares out. Nineteen sprung, nothing in them. Two gone entirely, wire and stake, pulled clean out of the ground. And one with a hare in it that had been dead three days and got up when I touched the line. So business is brisk, and I've stopped eating what I catch.",
		...
		"s_why": {"who": "Snarehand Ott", "text": "Because a snare tells you which way things are moving, and everything out here has started moving the same way, and it isn't away from the camp. Elder Maren's people won't pay for that, they want reports with maps on them. I'll keep the line anyway. A man should know which direction the country is walking.", "next": ""},
		"s_wire": {"who": "Snarehand Ott", "text": "He counts out the coil without a word, takes the coin, and re-ties the last snare with what's left, shorter, closer to the path, angled at something a lot larger than a hare. \"Aye. Well. You've bought me a reason to set the good one.\"", "next": ""},
	}},
