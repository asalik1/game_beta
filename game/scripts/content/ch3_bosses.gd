	...
	"sexton": {
		...
		"mechanics": [
			{"name": "Chain-Detonating Corpses",
			 "tell": "Shamblers keep clawing up around you. Each one that dies leaves a corpse, and a corpse falling near another drops two blast circles.",
			 "counter": "The adds drop zero loot, so don't farm them. Kill them spread out so their corpses never fall within a body's length of each other."},
			{"name": "Shovelwork",
			 "tell": "He bursts into churned earth and vanishes underground, tearing a line of eruption circles at your feet. Where he surfaces, the torn ground stays a lingering brown patch that keeps burning.",
			 "counter": "Step off the line. The eruptions walk outward one after another. He can't be targeted while he's buried, so save your burst for when he surfaces, then don't stand on the patch he leaves behind."},
			{"name": "Churning Earth",
			 "tell": "The ground heaves in a churned-earth burst right under you about every 4.5s, no matter where you stand or how far you've kited.",
			 "counter": "You can't outrange it, there's no safe distance. Learn the ~4.5s timing and sidestep each burst as you move."},
		],
	},
	...
	"vess": {
		...
		"mechanics": [
			{"name": "The Silence",
			 ...
			 "counter": "It's an inverse telegraph: everywhere is the wail. Sprint into the silent circle and wait out the scream."},
			...
			{"name": "Keening (30%)",
			 "tell": "At 30% she screams and glows blue-white, and the Silence now shows a second flickering circle.",
			 "counter": "The flickering circle is a decoy. The steady, solid one is the real shelter, so trust the calm one."},
		],
	},
	...
	"saint_varo": {
		...
		"mechanics": [
			{"name": "Blighted Censers",
			 ...
			 "counter": "He heals while any censer burns, so make them the priority. Snuff all three out before you commit damage to the saint, and again after each relight."},
			{"name": "The Toll",
			 ...
			 "counter": "Stand in a shadow before the bell lands. Fewer appear each time, so don't linger. Expect a tighter squeeze on every toll."},
			...
			{"name": "Saint Varo Stands (25%)",
			 ...
			 "counter": "His toll and slam come far more often now, so burn him down fast and keep the censers dead so nothing buys him time."},
		],
	},
