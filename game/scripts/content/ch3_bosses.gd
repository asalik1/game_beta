...
const ENEMIES := {
	...
	"sexton": {
		...
		"mechanics": [
			...
			{"name": "Shovelwork",
			 "tell": "He bursts into churned earth and vanishes underground, tearing a line of eruption circles at your feet — and where he surfaces the torn ground stays a lingering brown patch that keeps burning.",
			 "counter": "Step off the line — the eruptions walk outward one after another. He's untargetable while buried, so save your burst for when he surfaces; then don't stand on the patch he leaves behind."},
			{"name": "Churning Earth",
			 "tell": "The ground heaves in a churned-earth burst directly under you about every 4.5s — no matter where you stand or how far you've kited.",
			 "counter": "You can't outrange it; there's no safe distance. Learn the ~4.5s cadence and sidestep each burst as part of your movement rhythm."},
		],
	},
