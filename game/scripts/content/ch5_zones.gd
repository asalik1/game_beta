...
const ENEMIES := {
	...
	"hushcaller": {"name": "Hushcaller", "sprite": "witch", "hp": 350.0, "dmg": 66.0, "speed": 100.0, "xp": 16, "gold": 22, "ranged": true, "scale": 3.3,
	...
	"frozen_guard": {"name": "Frozen Guard", "sprite": "skeleton", "hp": 460.0, "dmg": 70.0, "speed": 130.0, "xp": 16, "gold": 22, "ranged": false, "scale": 3.3,
