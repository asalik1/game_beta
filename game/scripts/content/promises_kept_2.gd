...
const CONVOS := {
	...
	"ch3_wander_defector": {"start": "f1", "nodes": {
		"f1": {"who": "Brother Osk (formerly)",
			"text": "I keep the count. Fourteen thousand, two hundred and six unburied, gate to cathedral. The Choir never counted, because counting implies you might one day finish. I left over the counting. It seemed a small thing to leave a faith over, until I understood it was the whole faith.",
			"variants": [
				...
				{"flag": "vess_dead", "text": "You're back, and you'll want to see this, of all people. The aisle's gone quiet up the hill, and word of whose hand did it reached even a counter's corner. And down here the thing that couldn't happen is happening: the count is moving. Come read the ledger, bearer. The one you told me to keep.", "next": "f_down"},
		...
		"f_down": {"who": "Brother Osk (formerly)",
			"text": "He turns the ledger so you can read it. The last standing line is FOURTEEN THOUSAND TWO HUNDRED AND SIX, struck through, twice, and under it in a hand that shook: FOURTEEN THOUSAND ONE HUNDRED AND NINETY-ONE. \"Fifteen,\" he says. \"Fifteen closed since the singing stopped, dug and filled the same day, the way I did before it all went mad. Nineteen years I've added to this count. I've never once had cause to subtract. ...You said it like weather, bearer, like the burying was simply coming. It wasn't coming. It was waiting. On somebody to make the aisle go quiet.\"",
			"choices": [
