...
const ENEMIES := {
	...
	"forge_acolyte": {"name": "Forge Acolyte", "sprite": "mummy_mage", "hp": 250.0, "dmg": 46.0, "speed": 100.0, "xp": 15, "gold": 18, "ranged": true, "scale": 3.2,
		...
		"lore": "They attended one of Ordo's sermons out of curiosity. The Judge's court doesn't have a public gallery; everyone present is staff."},
...
const QUESTS := {
	...
	"forgemistress": "Cross the ash flats and stop Forgemistress Calda at her quenching yard",
	"cinderhide": "Descend the vent fields and crack Cinderhide's plating",
	"ashpriest": "Climb the Judgment Stair and end Ashpriest Ordo's sermon",
...
const BEATS := {
	"pre_forgemistress": [
		...
		["Forgemistress Calda", "The Judge whispers tolerances no mortal forge can hold, and my blades hold them anyway. Come on, let's find out what you hold."],
	],
	"post_forgemistress": [
	...
	"pre_ashpriest": [
		["Ashpriest Ordo", "Ah. The court was expecting you. You're on the docket, bearer. You've been on it since the Vale."],
...
const CONVOS := {
	...
	"ch4_cinder": {"start": "c1", "nodes": {
		"c1": {"who": "Envoy Cassia",
			"text": "Envoy Cassia, Cinderborn Compact. Let me say the quiet part first, since everyone thinks it anyway: yes, the Compact drilled here. Yes, something under the rock woke up. And no, we're not sorry, because the ore from this line will arm every wall in Vaelscar when the Waking comes for the rest of you.",
			"variants": [
	...
	"ch4_shrine_font": {"start": "f1", "nodes": {
		...
		"f_listen": {"who": "Narrator", "text": "The tolerances arrive: how hard to swing, exactly. Where the flaw in any guard lives, exactly. It's true, all of it, and your hands feel surer already, and underneath the knowing, faint as a stamp on hot metal, the sense of a docket somewhere gaining one more name. The knowledge was free. The listening wasn't.", "next": ""},
		"f_leave": {"who": "Narrator", "text": "You back out the way the miners backed out. The voice in the slag doesn't call after you; courts don't chase. But as the chamber door closes you hear, distinctly, the sound of a case file being set aside for later.", "next": ""},
	}},
	"ch4_shrine_court": {"start": "c1", "nodes": {
		"c1": {"who": "Narrator",
			"text": "Nine foundry workers ring a kneeling man, Foreman Dask, who sealed the vent door with crew five still inside. \"Procedure,\" he keeps saying, to the floor. The crew hasn't touched him. They're waiting, and when they see you every face turns: an armed stranger, shard-lit, arriving out of the heat like something sent. \"You judge,\" one says. \"Whatever you say, we'll do.\" The Judge's whisper agrees, warmly. This is, it murmurs, precisely what verdicts are for.",
			...
			"choices": [
				{"text": "\"No. He goes topside for a real trial. You're grieving, I'm armed, and neither of us gets to be a court.\"",
		...
		"c_refuse": {"who": "Narrator", "text": "For a moment nothing moves: nine grieving people and one whisper, all weighing you back. Then the oldest of them lets out a breath sixty hours old. \"...Topside. Aye.\" They bind Dask's hands gently, like people handling the last fragile thing they own. The whisper says nothing. Refusing an offered gavel, it turns out, is a verdict it has no appeal for.", "next": ""},
		"c_judge": {"who": "Narrator", "text": "GUILTY. The word comes out in your voice and lands with someone else's weight. Nine faces flood with relief, carried, absolved, led, and the whisper under the floor purrs like a signed docket. It's only later, replaying it, that you notice the detail: you never asked Dask a single question. The verdict felt too right to need one. That's how the Judge's verdicts feel. All of them.", "next": ""},
	...
	"ch4_wander_preacher": {"start": "w1", "nodes": {
		"w1": {"who": "Lay Preacher Immo",
			"text": "Brother! Have you heard? The fires judge fairly! No coin sways them, no rank, no pleading. The first honest court in Vaelscar sits under this very rock! I attend the sermons weekly. I've never felt so seen.",
			"variants": [
