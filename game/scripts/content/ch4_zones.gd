	...
	"ch4": [
		...
		},
		{
			...
			"enemies": [
				...
				["cinder_whelp", 1700, 450, 2], ["cinder_whelp", 1820, 560, 2],
				["slag_brute", 1000, 950, 3], ["slag_brute", 1130, 880, 3],
			],
			"boss": "",
		},
		{
		...
		},
		{
			...
			"enemies": [
				...
				["slag_brute", 1350, 880, 1, 26], ["slag_brute", 1470, 800, 1, 26],
				["slag_brute", 1410, 980, 1, 26], ["slag_brute", 1530, 900, 1, 26],
				["vent_skitter", 1750, 420, 2, 26], ["vent_skitter", 1850, 530, 2, 26],
				["forge_acolyte", 1000, 620, 3, 26], ["forge_acolyte", 1130, 550, 3, 26],
				["slag_brute", 950, 760, 3, 26], ["slag_brute", 1080, 830, 3, 26],
			],
			"boss": "",
		},
		{
