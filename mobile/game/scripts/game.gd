...
func _ready() -> void:
	...
	# MOBILE SNAPSHOT: the on-screen touch controls (§10). Shown on a real
	# phone/tablet, or on desktop with `--touch` so the mouse (via
	# emulate_touch_from_mouse) can drive them for verification.
