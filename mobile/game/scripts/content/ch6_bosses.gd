...
const ENEMIES := {
	...
	"auroch": {
		...
		"mechanics": [
			{"name": "Submerge",
			 "tell": "It bellows, then sinks below the bog where you can't target it, tearing a line of eruption circles that walk toward you while two bog-spawn adds claw up. Then it surfaces in a slam right under your feet.",
			...
			{"name": "Gore Rush",
			 ...
			 "counter": "Once it starts, it commits to the line. Dodge perpendicular, never straight backward."},
			{"name": "Wallow",
	...
	"gardener": {
		...
		"mechanics": [
			...
			{"name": "Compost",
			 "tell": "A bloom that dies within a body's length of Rotmaw gets composted, and he visibly mends a chunk of health ('he composts the bloom').",
			...
			{"name": "Full Bloom (30%)",
			 "tell": "At 30% he glows and roars that it's full bloom. Blooms sprout faster and thicker, and the vine lash comes more often.",
	...
	"curetwisted": {
		...
		"mechanics": [
			{"name": "Huntress Charge & Spear",
			 ...
			 "counter": "Dodge the charge sideways and keep moving so the spear's circle lands empty. Kiting no longer buys free time, since the thrown spear reaches you at range."},
			{"name": "Form Swap",
			 "tell": "At 80/60/40/20% HP she hard-swaps forms with a roar. She roots in place as the Bloom ('the Root wants to stay'), then snaps back to the mobile Huntress ('...still me').",
			...
			{"name": "The Root Lets Go (10%)",
			 ...
			 "counter": "The fight ends on your terms here: a strike-or-sheathe choice, not a damage race. She dies either way, so pick how."},
		],
	},
}
