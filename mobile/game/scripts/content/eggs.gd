...
const CONVOS := {
	"ch1_hatless_man": {"start": "h1", "nodes": {
		"h1": {"who": "Narrator",
			"text": "A man stands at the lip of the ravine, faced into the wind, not moving. The posture is wrong — too still, too long, the way nothing living holds itself. When your step turns him, the face is a ruin the blight has been at, and the eyes have the flat shine of deep water. He is bareheaded. The wind moves what's left of his hair the way it moves the dead grass.",
			"variants": [
				{"flag": "heron_father_met", "text": "The hatless man still stands at the ravine's lip, faced into the howling, going nowhere and never stopping. He does not turn for you a second time. There was never a second thing to see.", "next": ""},
				{"flag": "hat_given", "text": "A man stands at the lip of the ravine, bareheaded, and one hand drifts up to his scalp and feels along it — slow, patient, hunting for a brim that is a day's walk south now, pinned up with a wolf tooth on a boy who swallowed it to the eyebrows. He does not find it. Something in the ruin of his face almost remembers what it is looking for, and cannot, and keeps looking.", "next": "h2"},
			],
			"next": "h2"},
		"h2": {"who": "Narrator",
			"text": "He was going toward the howling. He is still going toward the howling. Whatever the wood took from him it left the walking, and pointed it the one direction.",
			"choices": [
		...
		"h_speak": {"who": "Narrator",
			"text": "The word BOY moves nothing behind his eyes. SAFE moves nothing. STOP moves nothing — those are words for the living, and he set them down at the ravine's edge with everything else that had weight. He turns back into the wind. After a moment the walking starts again, one foot, then the other, toward a howling that has all the time there is. You brought his hat home. That was the only part of this that could be finished.", "next": ""},
		"h_leave": {"who": "Narrator",
			"text": "You leave him to it. Behind you the walking starts again — one foot, then the other, the direction the wood pointed him and the only one it left. Somewhere south a boy stands straighter under a hat two sizes too big. Both of those are true at once. The wood will not reconcile them for you.", "next": ""},
	}},
