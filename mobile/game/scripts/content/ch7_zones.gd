...
const ENEMIES := {
	"storm_harrier": {"name": "Storm Harrier", "sprite": "storm_harrier", "hp": 950.0, "dmg": 88.0, "speed": 195.0, "xp": 13, "gold": 32, "ranged": false, "scale": 3.1,
		...
		"lore": "Plains hounds that learned to run ahead of the thunder. Lately the thunder runs ahead of them, and it's made them mean."},
	# Hostile-human rule (2026-07-09): vow_sentinel_* / static_caller_* are the
	# royal_soldier / bandit_sorcerer bodies darkened+desaturated (hostile pass)
	# — mobs never wear an UNMODIFIED friendly-NPC body.
	"vow_sentinel": {"name": "Vow Sentinel", "sprite": "vow_sentinel", "hp": 1250.0, "dmg": 92.0, "speed": 130.0, "xp": 15, "gold": 34, "ranged": false, "scale": 3.4,
		"physres": 42.0, "magres": 25.0, "eva": 0.0, "critres": 3.0, "dmg_type": "phys",
		"level": 38, "hp_g": 0.11, "dmg_g": 0.09, "traits": ["counter"],
		"lore": "Dead keepers of the recitation relay, still walking their circuits. The vow outlived the vowing. That's either loyalty or its skeleton."},
	"static_caller": {"name": "Static Caller", "sprite": "static_caller", "hp": 1000.0, "dmg": 96.0, "speed": 100.0, "xp": 15, "gold": 34, "ranged": true, "scale": 3.2,
		"physres": 12.0, "magres": 45.0, "eva": 0.0, "critres": 3.0, "dmg_type": "magic",
		"level": 38, "hp_g": 0.11, "dmg_g": 0.10, "traits": ["channel_heal", "snare"],
		"lore": "Order zealots who followed Cyrraeth into listening. They speak in half-sentences now, and the storm finishes the other half. Its grammar hurts."},
...
const QUESTS := {
	...
	"stormdrake_veyx": "Cross the steppe and ground Veyx, the Unchained Current",
	"unnamed_echo": "Enter the tear and cut down the Echo of the Unnamed",
	"stormmouth": "Climb the Recitation Stair and silence Cyrraeth, Mouth of the Storm",
	"done_ch7": "ACT 1 COMPLETE. The seal is cracked, and the mid game begins.",
}

const BEATS := {
	"pre_stormdrake_veyx": [
		["Narrator", "The rods of the old conductor field hum like struck glass. Between them the air bunches, gathers, and stands up. It has no face and doesn't need one. Delight, it turns out, is a shape."],
	...
	"pre_unnamed_echo": [
		...
		["The Echo of the Unnamed", "The void kept a copy. The void keeps everything, and that's what they sealed it for. Look at me, bearer. Someone has to be looking, this time."],
	],
	"post_unnamed_echo": [
		["Narrator", "The Echo doesn't scatter like the shades do. It folds, slowly, watching you the whole way down, and at the end it says a name. One word, in a voice suddenly human, and the void takes the sound before it reaches you. You'll spend longer than you'd like wondering whose it was. That, you suspect, was the point."],
		["Narrator", "Beyond the aisle, up the last stair, a single voice recites against the thunder. It has been reciting for six hundred years, in relay. It's down to one speaker, and he has stopped saying the words in order."],
	],
	"pre_stormmouth": [
		["Cyrraeth", "...and the word wasn't silence, bearer, that's the mistranslation, six centuries of it. The word was wait. We were never keeping it in. We were keeping it waiting. I stopped mid-sentence one night to hear what waited, and it has such things half-said..."],
	...
	"epilogue_ch7": [
		...
		["Narrator", "Then the sky answers. The crack runs horizon to horizon, soundless and absolute, void showing through the storm like bone through a wound. Not open. Cracked. Every hound on the plains sits down at once. Somewhere below, eleven camps and two factions look up from what they were doing, and don't look away."],
		["Elder Maren", "So. Six hundred years of the Concord's grace, spent to the last syllable, and no one alive knows the recitation now. Hear me, bearer, because I'll only say this once and never as a reproach: every road that led here, you walked right. And it led here anyway. That's what the mid game of a war looks like. Rest tonight. Tomorrow we learn what a cracked seal costs."],
	],
}
...
const CONVOS := {
	...
	"ch7_briefing": {"start": "m1", "nodes": {
		...
		"m3": {"who": "Elder Maren", "text": "Cyrraeth won't be talked back. Three of mine tried; the storm answered for him. So it comes to you, and I won't dress it up: kill him and the recitation dies with him, and the seal cracks. Spare him and the seal cracks slower, with a god-king's mouth attached. There's no road out of this chapter where the sky holds, bearer. There's only who is standing under it after.",
			"choices": [
				...
				{"text": "\"A cracked seal means power loose for the taking. Someone will hold it, so better me than the factions.\"",
	...
	"ch7_cinder": {"start": "c1", "nodes": {
		"c1": {"who": "Consul Verane",
			...
			"variants": [
				...
				{"flag": "joined_cinderborn", "text": "Consul Verane, bearer, and to one of our own I'll say what the envoys can't: the heir question is being settled, this season, in rooms you've earned a chair in. Survive the stair. The Compact doesn't spend proven assets; it promotes them."},
			],
			"next": "c2"},
		"c2": {"who": "Consul Verane", "text": "Tomorrow there's a hole in the sky and a continent full of terrified people, and terrified people don't want shards gathered or thrones broken. They want walls, bread on schedule, and someone visibly in charge. The empire delivered all three for two hundred years. We will again. The only open question is whether the person in charge is worthy this time, and bearer, the Compact's shortlist has gotten very short and very interesting since the Deep.",
			"choices": [
	...
	"ch7_shrine_vowstone": {"start": "v1", "nodes": {
		...
		"v_listen": {"who": "Narrator", "text": "You listen. Under the stone: half a sentence, patient beyond geology, and it isn't raging, that's the vertigo of it. It's reasonable. It has been mid-word for six hundred years, and it just wants to finish the thought, and every part of you that has ever been interrupted leans in with terrible sympathy. You pull away before the second clause lands. Mostly before. The shard hums the fragment for hours after, like a tune it means to learn, and now you understand Cyrraeth completely, which was the price of listening, and possibly the purpose.", "next": ""},
		"v_cover": {"who": "Narrator", "text": "You shelter the carving from the rain with your palm. Pointless; it has weathered six hundred years of storms. You stand a moment in the bent weather doing the vow's work without the vow's words. The stone neither thanks you nor tests you. But when you take your hand away, the carved line is dry, and stays dry, all the time you can see it going down the hill. Small courtesies between keepers. Even unofficial ones.", "next": ""},
	}},
	"ch7_shrine_summit": {"start": "s1", "nodes": {
		"s1": {"who": "Narrator",
			...
			"choices": [
				{"text": "Set your bared shard-hand in the Accord's empty casket, one breath, and let the iron take its measure. A promise of the ending where everyone is smaller and free.",
