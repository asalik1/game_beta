...
const ENEMIES := {
	...
	"grave_cutter": {"name": "Grave Cutter", "sprite": "mummy_rogue", "hp": 110.0, "dmg": 24.0, "speed": 155.0, "xp": 14, "gold": 10, "ranged": false, "scale": 3.2,
		...
		"lore": "A tomb-thief wrapped tight and cut loose, embalmed with its own knives still in hand."},
	...
	"wildkin_elf": {"name": "Wildkin Skirmisher", "sprite": "elf_wild", "hp": 95.0, "dmg": 18.0, "speed": 145.0, "xp": 12, "gold": 9, "ranged": false, "scale": 3.1,
		...
		"lore": "Blue-marked and barefoot, it fights for a grove no human tongue has a name for."},
	# --- sewer rat crew ---
	...
	"tick": {"name": "Gorged Tick", "sprite": "tick", "hp": 28.0, "dmg": 9.0, "speed": 215.0, "xp": 8, "gold": 5, "ranged": false, "scale": 3.0,
		...
		"lore": "Bloated and blood-slow until it isn't. Salvaged art still waiting on a home, a parasite for some future rot."},
