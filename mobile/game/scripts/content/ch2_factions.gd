...
const CONVOS := {
	...
	"ch2_accord_recruit": {"start": "a1", "nodes": {
		"a1": {"who": "Warden Callis",
			...
			"variants": [
				...
				{"band": "tempted", "text": "The warden's hand settles on her hilt before she speaks. Casually, precisely. \"Shard-bearer. I'll make the Accord's case anyway. Call it optimism under arms. We gather the shards, we break the throne, and we ask people like you to become less before that voice makes you more.\""},
				{"band": "steady", "text": "\"Shard-bearer.\" The warden looks you over once and, remarkably, relaxes. \"You hold it well. That's exactly who the Accord wants. We gather the shards, break the hollow throne, and ask the strong to become less so the world can be more. Few would carry the asking better than you.\""},
			],
			"next": "a2"},
		"a2": {"who": "Warden Callis", "text": "Join us, and your first task is honest work. Survey what the Waking's made of the east road. No thrones, no leashes. Just the slow, unglamorous mending of the world.",
			"choices": [
		...
		"a_join": {"who": "Warden Callis", "text": "Then welcome to the long defeat, colleague. That's Accord humor, you'll learn to survive it. East road. Eyes open. Report what the blight's taken.", "next": ""},
		...
		"a_status": {"who": "Warden Callis",
			...
			"next": "",
			"choices": [
				{"text": "\"The survey's done. The Greyrun is scouted. Here's what the blight's taken.\"",
	...
	"ch2_cinder_recruit": {"start": "c1", "nodes": {
		...
		"c_status": {"who": "Envoy Vessa",
			"text": "\"The seal, when you have it. The east road ate an imperial courier and his satchel, and history's written by whoever holds the paperwork.\"",
			"variants": [
				{"flag": "cinder_arc1_done", "text": "\"Ah, my favorite associate. The one whose paperwork actually arrives. The seal's already opening doors in three provinces. There'll be more commissions. There's always more history to hold.\"", "next": ""},
			],
			"next": "",
			"choices": [
	...
	"ch2_choir_pilgrim": {"start": "h1", "nodes": {
		...
		"h_listen": {"who": "Narrator", "text": "The verse is about a garden that stopped pretending. It's beautiful the way a flooded quarry is beautiful, and it stays in your head three days longer than you'd like.", "next": ""},
		"h_rebuke": {"who": "Choir Pilgrim", "text": "\"The garden doesn't mind,\" she says mildly, and keeps humming. Somehow that's worse than an argument.", "next": ""},
	}},
}
