	...
	"ch6_briefing": {"start": "b1", "nodes": {
		"b1": {"who": "Deacon Vela",
			...
			"variants": [
				...
				{"flag": "ch6_took_cutting", "text": "Empty your pockets, bearer. …No? Then hear the count: eleven pilgrims came back from the Deep carrying 'just a sprig'. I have buried what nine of them turned into, and the other two I still hear at night."},
