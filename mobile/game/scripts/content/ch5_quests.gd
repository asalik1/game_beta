...
const SIDE_QUESTS := {
	"ch5_forty_mouths": {
		"name": "Forty Mouths",
		"chapter": "ch5",
		"desc": "Hrolgar's toll died with him, but the toll-grain still sits cached on the white road, and the winterfang have found it. Yri will see it handed out by need, not by watch-rota, if someone drives the beasts off and carries it back honest.",
		"steps": [
...
const CONVOS := {
	...
	"ch5_briefing": {"start": "b1", "nodes": {
		"b1": {"who": "Tracker Yri",
			...
			"variants": [
				...
				{"flag": "ch5_vowed_morning", "text": "You walked in already promising morning to people under the ice. Hold to that when the valley starts calling sleep mercy. Promises are warm work here."},
				{"flag": "ch5_felt_pull", "text": "You've heard it already, then. The hush. Suli calls it the Queen's mercy; I call it bait that doesn't need a hook. Either way, bearer, walk next to me, not ahead."},
				{"flag": "ch5_kept_ledger", "text": "Road only, no theology. I understand. But the wagons on that road carry people, not entries. Keep your ledger honest enough to count their faces."},
		...
		"y_honor": {"who": "Tracker Yri", "text": "...Sing him honest. Aye. The clans will hear that a stranger spoke of Hrolgar like a chieftain and not a toll-gate, and that buys more peace than the grain did. I'll see the grain replaced somehow. Walk warm, bearer. You just did.", "next": "sq_hub"},
		...
		"sq_census_done": {"who": "Tracker Yri", "text": "A chapel full, and the one they're all walking toward. ...Aye. I'll send the count south with the next rider, and let the Accord put a number under the word 'valley' for once. Kept count is kept faith, bearer. The clans thank you for both.", "next": ""},
	...
	"ch5_mother": {"start": "m1", "nodes": {
		...
		"m_song": {"who": "Narrator", "text": "You read it low, like the skald said. A thaw. A river loosening. Somebody's boots drying by a door, because the somebody came home. Ansa listens the whole way through with her eyes shut, and when she opens them she's looking south, the first time you've seen her face that way. \"Toma will ask for the river part twice,\" she says. \"When he wakes, I'll have it ready. Thank the skald. Tell him it landed.\"", "next": ""},
	}},
	...
	"ch5_shrine_wagon": {"start": "w1", "nodes": {
		...
		"w_road": {"who": "Narrator", "text": "The snow keeps its slow accounting of the wheel-ruts. By the road's shoulder a waymarker leans over the porters' cache-stone, and whatever the road is still owed, it holds.",
			"choices": [
				{"text": "Dig out the porters' roadside cache: the ridge-toll grain, bound for a watch that no longer collects.",
					"req_flag": "sq_on_ch5_forty_mouths", "req_not_flag": "ch5_grain_taken",
					"gain_item": "ch5_grain_bundle", "flags": {"ch5_grain_taken": true}, "next": "w_grain"},
		...
		"w_skim": {"who": "Narrator", "text": "The measure you keep sells easily at the waystation. Grain is coin in famine winters. The cord goes back on re-tied, and you tie it well, and it's not Hrolgar's knot. You shoulder the rest. It rides lighter than it should, which is the trouble with carriers' shares: the missing weight travels with you anyway, and it doesn't make porridge for anyone.", "next": ""},
	}},
	...
	"ch5_wander_skald": {"start": "k1", "nodes": {
		...
		"k_spring": {"who": "Skald Ottar", "text": "He sings it, short and unadorned, a thaw and a river and someone's boots by a door. Halfway through, three strangers at the fire go quiet and stare into their cups, and by the end a wagon-driver is weeping without noise. \"That's why nobody asks for it,\" Ottar says, retuning. \"Winter songs let you stay hard. The spring one reminds you what you're staying hard for.\"",
			"choices": [
				{"text": "\"Set it down in writing, skald. The Last Fire's had a winter of the Queen's hymn, so let it hear yours.\"",
		...
		"k_again": {"who": "Skald Ottar", "text": "\"Once more, then. It's short, the way spring usually is up here.\" A thaw, a river loosening, somebody's boots drying by a door because the somebody came home. He gives it to you whole, quieter the second time.",
			"choices": [
				{"text": "\"Set it down in writing, skald. The Last Fire's had a winter of the Queen's hymn, so let it hear yours.\"",
					"req_not_flag": "ch5_verse_taken", "resonance": 2.0,
					"side_quest": "ch5_spring_song", "gain_item": "ch5_spring_verse",
			...
			"next": ""},
		"k_write": {"who": "Skald Ottar", "text": "He writes small and sure, since skalds ration paper like meat, and folds it twice before it leaves his hand. \"Tell whoever hears it that it wants a low voice and a fire going. And southerner, bring me back the look on the first face that hears it. That's my fee, and I don't discount.\"", "next": ""},
	}},
}
