	...
	"ch5": [
		...
		},
		{
			...
			"enemies": [
				...
				["cultist", 1000, 950, 3, 29, 14], ["stormcult", 1130, 880, 3, 29, 14],
			],
			"boss": "",
		},
		{
		...
		},
		{
			...
			"enemies": [
				...
				["frozen_guard", 1350, 880, 1, 32], ["null_acolyte", 1470, 800, 1, 32, 18],
				["frozen_guard", 1410, 980, 1, 32], ["frozen_guard", 1530, 900, 1, 32],
				["stormcult", 1750, 420, 2, 32, 20], ["winterfang", 1850, 530, 2, 32],
		...
		},
		{
			...
			"enemies": [
				...
				["stormcult", 1350, 880, 1, 32, 18], ["frozen_guard", 1470, 800, 1, 32],
				["stormcult", 1410, 980, 1, 32, 18], ["frozen_guard", 1530, 900, 1, 32],
...
const QUESTS := {
	...
	"whitepelt": "Take the white road and move Hrolgar Whitepelt off the Watch Ridge",
	"icebound": "Descend to the keystone and face Serane the Icebound",
	"sleepkeeper": "Follow the hymn north and end Mother Halla's long sleep",
...
const BEATS := {
	...
	"pre_icebound": [
		["Serane the Icebound", "Six hundred years, four heralds, and eleven thieves have reached this gallery. I'm going to tell you what I told each of them: the keystone holds while I hold. Turn back."],
		["Serane the Icebound", "...You won't. None of them did either. Very well, bearer. I've been the lock on this door since before your bloodline had a name. Show me it was worth waking up for."],
	],
	"post_icebound": [
		["Serane the Icebound", "So. Strong enough after all. Then hear the accounting, bearer, while I still owe it: I was the lock. My ember, the bolt on her door. You haven't freed this valley..."],
		["Serane the Icebound", "...you've unbarred it. She'll test the door within the year. Be... be better than eleven thieves, when she does. Someone must be."],
	...
	"pre_sleepkeeper": [
		["Mother Halla", "Oh, child. Look how far you've walked, and how heavy. Whitepelt, Serane, you've been carrying them for miles, haven't you. Sit. Sit down. No one here will hurt you."],
		["Mother Halla", "I lost three to the famine before the Queen taught me: the cold isn't the enemy, the waking is. Everyone I gather sleeps safe until the morning she brings. I'd so like you to stop fighting mornings. Ssshh, now."],
	],
	"epilogue_ch5": [
		["Narrator", "Halla folds down into the snow with no violence at all, like a candle relieved of its flame. Around the arena, one by one, the dreamers stop drifting, and some of them, some, begin to shiver. Shivering is what waking cold feels like. It's the best sound you've heard in weeks."],
...
const CONVOS := {
	...
	"ch5_sleeping_house": {"start": "n1", "nodes": {
		"n1": {"who": "Narrator",
			"text": "A woman sleeps sitting against the doorpost, shawl frosted stiff, the door open behind her the way it was when the sleep came down the street. Inside, the cold has kept the room honest: a family in their beds, breathing the Queen's slow breath, the father's boots laced by the hearth for a morning he's still expecting. At the foot of the girls' bed sits a dowry chest, brass-bound, unlocked, packed the autumn the snow came early.",
			"variants": [
		...
		"n_take": {"who": "Narrator", "text": "Linen. A string of river pearls. Coin saved in a stocking against a wedding. Carried out past sleeping faces that don't stir. Nothing wakes them; that's the whole shape of the theft. You latch the door behind you. It seems important, after.", "next": ""},
	}},
	...
	"ch5_briefing": {"start": "b1", "nodes": {
		"b1": {"who": "Tracker Yri",
			"text": "So the south sends a shard-bearer. Yri, Wildfang, one of the winter clans. Before anything else, understand what you're walking into: nobody out there is evil. That's what makes this one hard.",
			"variants": [
		...
		"b3": {"who": "Tracker Yri", "text": "Hrolgar Whitepelt holds the Watch Ridge for them. He is not corrupted, not mad, not cruel. He's a chieftain who found one way to feed forty mouths and doesn't ask what the wagons carry. You'll have to move him, and he won't move. I'm asking you to know all of that before the ridge, not after.",
			"choices": [
		...
		"b_plain": {"who": "Tracker Yri", "text": "Every chance. He won't take it, since pride and forty mouths make a man immovable, but the offering matters. It'll matter to the clans, after. Walk warm, bearer.", "next": ""},
		...
		"y_after": {"who": "Tracker Yri", "text": "Hrolgar Whitepelt is dead, and his pack dragged him home, and forty mouths are asking what happens to the grain. So tell me straight, bearer, because the clans will hear it in your words: what happened on my ridge?",
			"choices": [
				{"text": "\"A chieftain held the only line he had, and lost to a stronger hand. Your clans should sing him honest, and I'll say so anywhere.\"",
		...
		"y_honor": {"who": "Tracker Yri", "text": "...Sing him honest. Aye. The clans will hear that a stranger spoke of Hrolgar like a chieftain and not a toll-gate, and that buys more peace than the grain did. I'll see the grain replaced somehow. Walk warm, bearer. You just did.", "next": ""},
	...
	"ch5_accord": {"start": "a1", "nodes": {
		"a1": {"who": "Warden Sighne",
			"text": "Warden Sighne, Accord. I'll not soften this one, bearer, because you've earned the unsoftened version. The keystone under the frozen shore is held by one of ours. Serane, Ember Guard, volunteered six hundred years ago to freeze at the seal as its living lock. She's still there. She's still loyal. And the Waking is wearing her through like rot through a roofbeam.",
			"variants": [
			...
			"next": "a2"},
		"a2": {"who": "Warden Sighne", "text": "Six centuries of strain have bent her one certainty into this: anyone who reaches the keystone has come to open it. She'll kill you believing she's saving the world, and if you kill her, the seal weakens, because the lock is her. Maren ran the arithmetic a dozen ways. A failing lock that kills pilgrims buys less time than a clean death and a watched door. So we ask. Flame forgive us, we ask.",
			"choices": [
		...
		"a_witness": {"who": "Warden Sighne", "text": "A witness. Yes. Six hundred years and the last thing she'll see is someone who knows. ...When it's done, there's a ledger in the gallery, the keepers' vigil-book. Read her line. It's four words long and it'll break your heart, and she deserves both.", "next": ""},
		"a_truth": {"who": "Warden Sighne", "text": "Yes. That's exactly what we're doing, and I'll thank you not to let me forget it. The Accord's whole war is choosing which debts to default on, bearer. Serane taught us how. She just never planned on being one of them.", "next": ""},
	}},

	# ---- Gentle Suli: the cult, at its most honest and most chilling.
	"ch5_cult": {"start": "s1", "nodes": {
		"s1": {"who": "Gentle Suli",
			"text": "You've the look of someone about to do violence to my faith, so let's be civil first. Suli. I drive wagons for the Long Sleep. And before your face does the thing every southern face does: my daughter is on one of those wagons. I put her there. She was dying, bearer. Now she's dreaming, and when the Queen's morning comes...",
			"variants": [
			...
			"next": "s2"},
		"s2": {"who": "Gentle Suli", "text": "...when the morning comes, she wakes healed. That's the promise. Sixty fevers, forty famines, one promise. You want to tell me it's a lie, and here's why you'll fail: nobody who sleeps has died. Not one, in nine years. Show me another faith in Vaelscar with that record.",
			"choices": [
	...
	"ch5_mother": {"start": "m1", "nodes": {
		"m1": {"who": "Ansa of the Shore",
			"text": "My husband and both boys sleep in the valley. I didn't consent. I was at market, one day, one single day, and Halla's people came through our village singing, and when I got home the beds were empty and the neighbor said they walked out smiling. Smiling. My youngest is afraid of the dark, bearer. Nobody who knows him would believe he walked toward that ice glad.",
	...
	"ch5_shrine_wagon": {"start": "w1", "nodes": {
		"w1": {"who": "Narrator",
			...
			"choices": [
				...
				{"text": "Haul it north, as the porter promised the families. Their kin chose the sleep, and finishing another's vow is not yours to unmake.",
		...
		"w_south": {"who": "Narrator", "text": "The traces bite your shoulders for two frozen miles. At the waystation they take the sleepers in by the fire, and by dusk three are shivering, and by night one of them, the child, opens her eyes and asks, furious, where her horse is. It's in her hand. Some of the others may never wake. You chose their risk without their leave, and you'll carry that. She's holding the horse, though. She's holding it.", "next": ""},
		"w_north": {"who": "Narrator", "text": "You lean where the porter leaned, and haul the vow to its keeping. At the ice-line the cult receives the wagon with tears of plain gratitude: eleven promises delivered, they say, eleven sleepers safe till morning. The shard says nothing all the long walk back. It's thinking, you suspect, about the difference between honoring a promise and feeding one, and it's glad, for once, that the thinking is yours to do.", "next": ""},
		"w_leave": {"who": "Narrator", "text": "You unhitch the dead porter and lay him decently by the road, and leave the wagon anchored where it stands. Someone will find it: the cult, the clans, the wardens; the road is walked. Someone with more right, you tell yourself, or at least more certainty. The snow starts an hour later. You don't go back to check. That, too, is a choice, and the shard files it with the others.", "next": ""},
	}},
	...
	"ch5_wander_mapper": {"start": "m1", "nodes": {
		"m1": {"who": "Cartographer Bree (Accord)",
			...
			"variants": [{"flag": "ch5_bree_met", "text": "Latest survey's done. The line held this season, the first time in four years it didn't move. Somebody up-valley is doing something right, and my professional guess is standing in front of me.", "next": ""}],
			"choices": [
	...
	"ch5_wander_memories": {"start": "w1", "nodes": {
		"w1": {"who": "Peddler Onna",
			...
			"choices": [
				...
				{"text": "\"Spiced oil for the freezing. The Queen sells the same comfort, peddler, and hers doesn't run out by morning.\"",
