...
const DATA := {
	...
	"crystal": {"name": "Crystal Caverns", "ground": "crystalfloor", "path": "crystalfloor",
		...
		"obstacles": ["crystal", "crystal", "pillar", "rock2", "boulder", "boulder2"], "decor": ["pebble", "crack", "rubble"], "accents": ["crystal_cluster", "crystal_spire", "geode"], "count": 14,
	...
	"holy": {"name": "Sanctified Ruins", "ground": "holystone", "path": "holystone",
		...
		"obstacles": ["pillar", "pillar", "rock", "rock2", "boulder"], "decor": ["flower", "crack", "pebble", "rubble"], "accents": ["grave_statue", "grave_angel"], "count": 11,
	...
	"spore": {"name": "Spore Glade", "ground": "sporesoil", "path": "sporesoil",
		...
		"obstacles": ["tree_spore", "tree_spore", "rock", "boulder", "tree_spore2"], "decor": ["mushroom", "mushroom", "toadstool", "toadstool2", "grass"], "accents": ["mushroom_purple"], "count": 13,
