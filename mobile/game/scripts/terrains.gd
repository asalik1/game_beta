...
const WALL := {
	...
	"ph_hollowgrove": "wall_moss",
	"ph_rootboundbog": "wall_wood",
	"ph_fungalcathedral": "wall_moss",
	"ph_mournfields": "wall_grave", "ph_barrowmoor": "wall_grave",
	"ph_ossuary": "wall_castle",
	"ph_ashflats": "wall_sand",
	"ph_obsidianreach": "wall_volcanic",
...
const STRUCTURES := {
	...
	# Plaza pot swap (owner flag 2026-08-21: clay_pot's source art is warped —
	# body bulges off-axis; re-roll queued). Width matches its obstacle-table
	# size; unlisted here = the 180px building default, a giant vase.
	"amphora": {"sprite": "amphora", "w": 34.0,
		"colliders": [{"shape": "circle", "radius": 10.0, "off": Vector2(0, -4.0)}]},
